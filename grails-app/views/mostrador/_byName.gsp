...
<div class="row">
    <div class="form-group">
        ...
        <input type="text" id="prodName" class="form-control" onkeyup="${remoteFunction(controller: 'mostrador', action: 'getProductsByName', update: [success: 'productList', failure: 'error'], params: ' \'name=\'+this.value')}"/>
