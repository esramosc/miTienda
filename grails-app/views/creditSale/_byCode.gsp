<div class="row">
    <div class="form-group">
        <label>Cliente: </label>
        <input type="text" name="customer" id="customer" class="form-control" autocomplete="off" onkeyup="${remoteFunction(controller: 'mostrador', action: 'getCustomers', update: [success: 'customerList', failure: 'error'], params: ' \'name=\'+this.value')}"/>
