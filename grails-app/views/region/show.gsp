		...
		<div id="show-region" class="content scaffold-show" role="main">
			...
			<ol class="property-list region">
				...
				<li class="fieldcontain">
					<span id="region-label" class="property-label"><g:message code="region.region.label" default="Region" /></span>
				...
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="region.description.label" default="Description" /></span>
				...
				<li class="fieldcontain">
					<span id="registerDate-label" class="property-label"><g:message code="region.registerDate.label" default="Register Date" /></span>
					
						<span class="property-value" aria-labelledby="registerDate-label"><g:formatDate date="${regionInstance?.registerDate}" /></span>
